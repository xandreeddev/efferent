...
// Source: https://models.dev/api.json (snapshot 2026-06-15)
...
export const MODEL_CATALOG: Record<string, CatalogEntry> = {
  "anthropic:claude-3-5-haiku-20241022": { contextWindow: 200000, maxTokens: 8192, cost: { input: 0.8, output: 4, cacheRead: 0.08 } },
  "anthropic:claude-3-5-haiku-latest": { contextWindow: 200000, maxTokens: 8192, cost: { input: 0.8, output: 4, cacheRead: 0.08 } },
  "anthropic:claude-3-5-sonnet-20240620": { contextWindow: 200000, maxTokens: 8192, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-3-5-sonnet-20241022": { contextWindow: 200000, maxTokens: 8192, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-3-7-sonnet-20250219": { contextWindow: 200000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-3-haiku-20240307": { contextWindow: 200000, maxTokens: 4096, cost: { input: 0.25, output: 1.25, cacheRead: 0.03 } },
  "anthropic:claude-3-opus-20240229": { contextWindow: 200000, maxTokens: 4096, cost: { input: 15, output: 75, cacheRead: 1.5 } },
  "anthropic:claude-3-sonnet-20240229": { contextWindow: 200000, maxTokens: 4096, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  ...
  "anthropic:claude-opus-4-0": { contextWindow: 200000, maxTokens: 32000, cost: { input: 15, output: 75, cacheRead: 1.5 } },
  ...
  "anthropic:claude-opus-4-20250514": { contextWindow: 200000, maxTokens: 32000, cost: { input: 15, output: 75, cacheRead: 1.5 } },
  ...
  "anthropic:claude-sonnet-4-0": { contextWindow: 200000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-sonnet-4-20250514": { contextWindow: 200000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-sonnet-4-5": { contextWindow: 200000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-sonnet-4-5-20250929": { contextWindow: 200000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  "anthropic:claude-sonnet-4-6": { contextWindow: 1000000, maxTokens: 64000, cost: { input: 3, output: 15, cacheRead: 0.3 } },
  ...
  "google:gemma-4-E2B-it": { contextWindow: 131072, maxTokens: 8192 },
  "google:gemma-4-E4B-it": { contextWindow: 131072, maxTokens: 8192 },
