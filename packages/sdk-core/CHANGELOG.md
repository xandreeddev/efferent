...
- 64efbfb: render_ui streams COMPONENTS, not whole pages — an edit swaps one region, not the tab.
...
- 604c0ec: Lift the coder-driver seams out of the CLI so any driver can build the real
...
- 6a2b3f6: The spec-driven pipeline's shared core: `SpecDoc` (Schema.Class — branded
