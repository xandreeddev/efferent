...
export class FileSystem extends Context.Tag("@xandreed/core/FileSystem")<
  FileSystem,
  {
    ...
    /** Resolve symlinks to the canonical absolute path. */
    readonly realPath: (path: string) => Effect.Effect<string, FsError>
