 ...
 */
export const HANDOFF_PROMPT = `You are summarizing a coding-agent conversation into a HANDOFF that will replace the detailed history. From the next turn onward this summary is the ONLY prior context the agent sees, so it must stand alone — be specific and complete enough to continue the work without the original messages.
