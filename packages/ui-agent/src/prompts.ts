export const UI_PLANNER_PROMPT_VERSION = "5.0.0"
export const UI_COMPOSER_PROMPT_VERSION = "6.0.0"
export const UI_REPAIR_PROMPT_VERSION = "3.0.0"
...
Every emitted block must have a manifest slot with the identical id and blockKind. Use registered asset IDs only; absent imagery is rendered as design-system artwork. Architecture diagrams use typed nodes and edges; every edge endpoint must name an emitted node.
