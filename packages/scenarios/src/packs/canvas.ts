...
import { eventWhere, toolSequence, turnAlternationValid } from "@xandreed/evals/evidence"
...
export const canvasPack: Pack = {
  ...
  threshold: 0.9475,
  judgeWeight: 0.35,
  meta: { "ui-agent-profile": "streaming-ui-v1@10.1.0", "ui-schema": "2.1.0", "recipe-set": "2.0.0", "ui-quality-rubric": UI_PAGE_QUALITY_RUBRIC_VERSION },
  scenarios: [
